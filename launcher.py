...
class Launcher:
    ...
    def _make_plot_stats(self):
        ...
        different_k3_arr_max_wait_time, different_k3_arr_max_late_time, different_k3_arr_wait_time_part, different_k3_arr_late_time_part, different_k3_arr_total_time = statistics.collect_additional_times()

        wait_arr, late_arr, total_arr, dist_arr = statistics.collect_bns_data()

        avg_wait_arr, avg_late_arr, avg_total_arr = statistics.collect_bns_additional_data()
        ...
        if self._plot_stats == 'time':
            ...
            self._plotter.plot_dataset_series_with_bns(self._testing_datasets, self._dims_array, different_k3_arr_total_time[0], avg_total_arr,
                                                       xlabel='Общее время в пути(сравнение с наилучшими решенияим)',
                                                       ylabel='Число клиентов', mapping=self._mapping)
